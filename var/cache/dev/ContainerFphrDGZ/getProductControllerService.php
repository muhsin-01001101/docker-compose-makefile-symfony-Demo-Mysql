...
class getProductControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.L3tjgf0'] ?? $container->load('get_ServiceLocator_L3tjgf0Service'))->withContext('App\\Controller\\ProductController', $container));
